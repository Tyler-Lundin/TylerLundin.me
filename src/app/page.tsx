...
export default async function LandingPage() {
  ...
  return (
    <main className="max-w-screen mx-2 md:mx-4 border border-black/10 dark:border-white/10 rounded-lg my-4 min-h-screen overflow-visible bg-gradient-to-b from-neutral-50 dark:from-black z-10 via-transparent to-white dark:to-black text-black dark:text-white ">
