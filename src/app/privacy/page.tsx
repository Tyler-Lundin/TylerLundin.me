...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen max-w-screen py-20 bg-white/95 py-40 dark:invert opacity-90">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg mx-auto">
          ...
          <p className="text-gray-600 mb-4">
            This website is built using Next.js and hosted on Vercel. I collect minimal information about our visitors:
          </p>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">How I Use Your Information</h2>
          <p className="text-gray-600 mb-4">
