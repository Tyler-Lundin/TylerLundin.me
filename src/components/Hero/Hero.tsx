...
export default function Hero() {
  ...
  return (
    <motion.div
      ...
      <h2 className={clsx('w-full h-fit mx-auto  text-xl bg-emerald-400 text-black font-black lg:text-2xl text-center rounded-md uppercase my-2 ', a.className)}> A Modern Web Developer </h2>
      <motion.div
